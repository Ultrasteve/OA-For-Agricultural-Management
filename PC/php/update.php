<?php
	 ...
	 $result = $con->query('SELECT * FROM zuowupinzhong  where NAME  = "'.$P_NAME.'"');
	  $arr = $result->fetch_assoc();
       $P_ID=$arr["ID"];
		...
		$result = $con->query('UPDATE '.$tablename.' SET   P_ID='.$P_ID.'  WHERE ID='.$input1.'');
	 }
	 if($tablename=="zhongzhihu")
	 {
		...
		$input5=$_GET["input5"];
		$input6=$_GET["input6"];
     $sql="INSERT INTO '.$tablename.' () VALUES (.'$input1'.,.'$input2'.,.'$input3'.,.'$input4'.,.'$input5'.,.'$input6'.)";
...
<?php
header("Location: http://cc307cc.hk156.ip.hl.cn/%E7%94%B5%E8%84%91/%E5%86%9C%E4%B8%9A%E9%A1%B9%E7%9B%AE/%E5%86%9C%E4%B8%9A%E9%A1%B9%E7%9B%AE%20%E6%96%87%E6%A1%A3%E4%BF%AE%E6%94%B9%E7%89%88/type_info.html#");
exit();
?>