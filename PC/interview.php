...
<html lang="en">
  <head>
    ...
    var password=<?php echo $_SESSION['password'];?>;
          var creator=FactoryOne("tianjianguanlijilu");//改
...
<!--开始菜单部分-->
  ...
  <div class="sidebar-nav">
      ...
      <ul id="plant-menu" class="nav nav-list collapse in">
          <li class="active"><a href="interview.php">田间管理记录信息</a></li>
...
<!--开始content部分-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">田间管理记录信息管理</h1>
        </div>
