...
<html lang="en">
  <head>
    ...
    var password=<?php echo $_SESSION['password'];?>;
          var creator=FactoryThird("zhongzhihuxinxi");
...
<!--开始菜单部分-->
  ...
  <div class="sidebar-nav">
      ...
      <ul id="MessageManagement-menu" class="nav nav-list collapse in">
          ...
          <li class="active"><a href="storage_info.php">物流仓储信息</a></li>
      </ul>
            ...
            <div class="row-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="modal small hide fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            ...
                            <form action="update.php" method="get">
                                ...
                                <label>预产期</label>
                                <input type="text" class="input-xlarge" name="input4">
                                <label>作物</label>
                                <input type="text" class="input-xlarge" name="input5">
                                <label>预产量</label>
                                <input type="text" class="input-xlarge" name="input6">

                                <input type="submit" class="btn" data-dismiss="modal" aria-hidden="true" value="更改确认">
                    ...
                    <div class="modal small hide fade" id="insert" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            ...
                            <form action="insert.php" method="get">
                                ...
                                <input class="btn" type="submit" data-dismiss="modal" aria-hidden="true" value="确认提交">
                                <input class="btn" type="reset" data-dismiss="modal" aria-hidden="true" value="取消">
                            </form>
                        </div>
                    </div>
                    <div class="modal small hide fade" id="updatefile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            <!--到时候需要改-->
                            <form action="updateexcel.php" method="get" enctype="multipart/form-data">
                                <input type="text" name="input0" value="zhongzhihu" style="display: none">
                                <label>上传文件</label>
