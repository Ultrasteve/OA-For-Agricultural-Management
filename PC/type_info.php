...
<html lang="en">
  <head>
    ...
    <script src="js/myFunction3.js" type="text/javascript"></script>
    <!-- Demo page code -->

      <script type="text/javascript">
    var username=<?php echo $_SESSION['username'];?>;
    var password=<?php echo $_SESSION['password'];?>;
          var creator=FactoryThird("zuowupinlei");  //改
...
<!--开始菜单部分-->
  ...
  <div class="sidebar-nav">
      ...
      <ul id="MessageManagement-menu" class="nav nav-list collapse in">
          <li class="active"><a href="type_info.php">作物品类信息</a></li>
                    ...
                    <div class="modal small hide fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            ...
                            <form action="php/update.php" method="get">
                                <input type="text" name="input0" value="zuowupinlei" style="display: none">
                                <label style="display: none">品类序号</label>
                                <input type="text" class="input-xlarge" name="input1" id="input1" style="display: none">
                                <label>品类名称</label>
                                <input type="text" class="input-xlarge" name="input2" id="input2">
                                <label style="display: none">所属品种序号</label>
                                <input type="text" class="input-xlarge" id="input3" style="display: none">
                                <label>所属品种名称</label>
                                <input type="text" class="input-xlarge" name="input3" id="input4">
                    ...
                    <div class="modal small hide fade" id="insert" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            ...
                            <form action="php/insert.php" method="get">
                                <input type="text" name="input0" value="zuowupinlei" style="display: none">
                                <label style="display: none">品类序号</label>
                                <input type="text" class="input-xlarge" name="input1" style="display: none">
                                <label>品类名称</label>
                                <input type="text" class="input-xlarge" name="input2">
                                <label style="display: none">所属品种序号</label>
                                <input type="text" class="input-xlarge" name="inpu" style="display: none">
                                <label>所属品种名称</label>
                    ...
                    <div class="modal small hide fade" id="updatefile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body" style="overflow:scroll;">
                            ...
                            <form action="php/updateexcel.php" method="get" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="btn" data-dismiss="modal" aria-hidden="true" value="确认提交">
                                <input type="reset" class="btn btn-danger"  data-dismiss="modal" value="取消">
                            </form>
                        </div>
                    </div>
            </div>
