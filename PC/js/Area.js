...
function changeComplexProvince(f, k, e, d) {  //this.value, sub_array, 'seachcity', 'seachdistrict'
    ...
    if(f=="0"){
        removeOptions(g);
        document.getElementById(d).innerHTML="<option  selected = 'selected'>请选择</option>";
        return;
    }
    var b = 0; var a = 0; removeOptions(h);
    f = parseInt(f);
    if (k[f] != undefined) {
